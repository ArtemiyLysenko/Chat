...
@Entity
@Table(name = "direct_dialogs")
class DirectDialogEntity {
    ...
    protected DirectDialogEntity() {
    }

    DirectDialogEntity(UUID id, UUID userLowId, UUID userHighId, Instant createdAt) {
        this.id = id;
