...
## Immediate Next Step
Implement Milestone 8.1 only: replace placeholder Jabber admin data with real queries, enforce admin-only authorization on the Jabber admin endpoints, and wire the classic-web admin screens to current XMPP connection and federation telemetry data.
