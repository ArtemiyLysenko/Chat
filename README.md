...
## Immediate Next Step
Implement Milestone 6.1 only: add the `session_tabs` migration, the presence feature and persistence foundation, and the ONLINE or AFK or OFFLINE derivation logic without claiming later WebSocket tab activity or browser badge work.
