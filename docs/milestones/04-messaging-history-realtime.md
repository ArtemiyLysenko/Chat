...
Milestone 4.1 and Milestone 4.2 are now implemented.
Milestone 4.3 remains open and is limited to realtime fan-out and live-session socket behavior.
...
- Milestone 4.3 only
  ...
  - server fan-out for `message.created`, `message.updated`, `message.deleted`, and `unread.updated`
...
- Federation
- For Milestone 4.2 specifically: `/ws`, live unread updates, live message fan-out, and session-revocation handling for sockets
...
- Automated
  ...
  - Milestone 4.3 later: WebSocket integration tests for `message.created`, `message.updated`, `message.deleted`, `unread.updated`, and live session revocation
- Manual
  ...
  - Milestone 4.3 later: reconnect and live fan-out proof
...
- Milestone 4.3 remains the only slice that may introduce `/ws` or live session-revocation handling.
